# Relief Ink Viscosity And Slab Roll Chart
...
- Negative constraints: No clean white product studio, no cosmetic palette aesthetic, no decorative typography, no unreadable notes, no fake plastic ink.
- Intended learning value: Teaches how ink body changes roller feel and print outcome so beginners can diagnose under-rolled, balanced, and over-rolled states before pulling another bad proof.
- Composition notes: The three slab closeups, printed swatch row, and paired descriptors such as `sticky`, `smooth`, and `streaky` keep the image useful in both search and studio troubleshooting.
- Format notes: Process chart for `relief ink viscosity chart`, `block printing ink consistency guide`, and `how much ink on a brayer`. Short text is deliberate; the complete classroom phrasing is preserved here.
- Scale tags: `page`, `tabletop`, `ink slab guide`
...
- File path of PNG: `image-knowledge-base/images/2026/05/25/20260525-0211-relief-print-registration-and-brayer-course-plates/04-relief-ink-viscosity-and-slab-roll-chart.png`
