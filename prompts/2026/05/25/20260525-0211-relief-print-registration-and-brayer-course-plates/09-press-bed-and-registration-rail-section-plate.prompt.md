...
- Negative constraints: No sterile engineering CAD, no glossy machine ad, no blueprint overload, no tiny annotations, no futuristic fabrication lab.
- Intended learning value: Explains how paper, blanket, block, rail, and pressure stack together inside a small relief-print press so students can connect setup language to machine geometry.
- Composition notes: The long side-section, proof strip header, and clear rail-to-tray flow give the image unusual spatial value compared with flatter poster-only explainers.
- Format notes: Section plate for `relief press bed diagram`, `printmaking registration rail`, and `small relief press anatomy`. This is a less-common atlas format and the prompt card preserves the stable machine vocabulary.
- Scale tags: `tabletop`, `object`, `section plate`
...
- File path of PNG: `image-knowledge-base/images/2026/05/25/20260525-0211-relief-print-registration-and-brayer-course-plates/09-press-bed-and-registration-rail-section-plate.png`
